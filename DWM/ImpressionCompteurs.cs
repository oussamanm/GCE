...
namespace DWM
{
    public partial class ImpressionCompteurs : DevExpress.XtraReports.UI.XtraReport
    {
        public ImpressionCompteurs()
        {
            InitializeComponent();
        }
        ...
        public void load()
        {
            ...
            //string str= wanted_path + "\\Resources\\" + Configuration.Func(8);
